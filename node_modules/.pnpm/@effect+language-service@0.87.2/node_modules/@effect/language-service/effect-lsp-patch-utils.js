...
function checkSourceFileWorker(tsInstance, program, sourceFile, compilerOptions, addDiagnostic, moduleName) {
  ...
  if (program.getCompilerOptions().skipLibCheck && parsedOptions.excludeExternalLibrariesWhenSkipLibCheck && program.isSourceFileFromExternalLibrary(sourceFile)) return;
  pipe(
