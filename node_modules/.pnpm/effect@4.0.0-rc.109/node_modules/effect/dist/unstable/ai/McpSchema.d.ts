...
declare const BlobResourceContents_base: Schema.Opaque<BlobResourceContents, Schema.Struct<{
     ...
     */
    readonly blob: Schema.Uint8ArrayFromBase64;
}>, {}> & Omit<Schema.Struct<{
    /**
     * The URI of this resource.
     */
 ...
 * @since 4.0.0
 */
export declare const ToolJsonSchema: Schema.Codec<ToolJsonSchema>;
declare const Tool_base: Schema.Class<Tool, Schema.Struct<{
     ...
     */
    readonly inputSchema: Schema.Codec<ToolJsonSchema, ToolJsonSchema, never, never>;
    /**
     * An optional JSON Schema object defining the structure of the tool output.
     */
    readonly outputSchema: Schema.decodeTo<Schema.optional<Schema.Codec<ToolJsonSchema, ToolJsonSchema, never, never>>, Schema.optionalKey<Schema.Codec<ToolJsonSchema, ToolJsonSchema, never, never>>, never, never>;
    /**
...
declare const CallToolResult_base: Schema.Class<CallToolResult, Schema.Struct<{
     ...
     */
    readonly structuredContent: Schema.decodeTo<Schema.optional<Schema.Codec<Schema.Json, Schema.Json, never, never>>, Schema.optionalKey<Schema.Codec<Schema.Json, Schema.Json, never, never>>, never, never>;
    /**
...
declare const McpReverseOperationUnsupported_base: new <A extends Record<string, any> = {}>(args: import("../../Types.ts").VoidIfEmpty<{ readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }>) => import("../../Cause.ts").YieldableError & {
    readonly _tag: "McpReverseOperationUnsupported";
} & Readonly<A>;
/**
 ...
 * @since 4.0.0
 */
export declare class McpReverseOperationUnsupported extends McpReverseOperationUnsupported_base<{
    readonly operation: "roots/list" | "sampling/createMessage" | "elicitation/create";
    readonly protocolVersion: ProtocolVersion;
    readonly reason: string;
}> {
}
declare const McpReverseOperationError_base: new <A extends Record<string, any> = {}>(args: import("../../Types.ts").VoidIfEmpty<{ readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }>) => import("../../Cause.ts").YieldableError & {
    readonly _tag: "McpReverseOperationError";
} & Readonly<A>;
/**
 ...
 * @since 4.0.0
 */
export declare class McpReverseOperationError extends McpReverseOperationError_base<{
    readonly operation: "roots/list" | "sampling/createMessage" | "elicitation/create";
...
export interface McpReverseClient {
    readonly listRoots: (request?: typeof ListRoots.payloadSchema.Type) => Effect.Effect<ListRootsResult, McpReverseOperationError | McpReverseOperationUnsupported>;
    readonly createMessage: (request: typeof CreateMessage.payloadSchema.Type) => Effect.Effect<CreateMessageResult, McpReverseOperationError | McpReverseOperationUnsupported>;
    readonly elicit: (request: typeof Elicit.payloadSchema.Type) => Effect.Effect<typeof ElicitResult.Type, McpReverseOperationError | McpReverseOperationUnsupported>;
}
...
declare const ClientRequestRpcs_base: RpcGroup.RpcGroup<Rpc.Rpc<"initialize", Schema.Struct<{
    _meta: Schema.decodeTo<Schema.optional<Schema.Struct<{
        /**
         * If specified, the caller is requesting out-of-band progress notifications
         * for this request (as represented by notifications/progress). The value of
     ...
     */
    clientInfo: typeof Implementation;
}>, typeof InitializeResult, Schema.Union<readonly [typeof ParseError, typeof InvalidRequest, typeof MethodNotFound, typeof InvalidParams, typeof InternalError, typeof McpErrorBase]>, typeof McpServerClientMiddleware, never> | Rpc.Rpc<"resources/read", Schema.Struct<{
    _meta: Schema.decodeTo<Schema.optional<Schema.Struct<{
        /**
         * If specified, the caller is requesting out-of-band progress notifications
         * for this request (as represented by notifications/progress). The value of
     ...
     */
    uri: Schema.String;
}>, Schema.Struct<{}>, Schema.Union<readonly [typeof ParseError, typeof InvalidRequest, typeof MethodNotFound, typeof InvalidParams, typeof InternalError, typeof McpErrorBase]>, typeof McpServerClientMiddleware, never> | Rpc.Rpc<"prompts/get", Schema.Struct<{
    _meta: Schema.decodeTo<Schema.optional<Schema.Struct<{
        /**
         * If specified, the caller is requesting out-of-band progress notifications
         * for this request (as represented by notifications/progress). The value of
     ...
     */
    arguments: Schema.decodeTo<Schema.optional<Schema.$Record<Schema.String, Schema.String>>, Schema.optionalKey<Schema.$Record<Schema.String, Schema.String>>, never, never>;
}>, typeof GetPromptResult, Schema.Union<readonly [typeof ParseError, typeof InvalidRequest, typeof MethodNotFound, typeof InvalidParams, typeof InternalError, typeof McpErrorBase]>, typeof McpServerClientMiddleware, never> | Rpc.Rpc<"tools/call", Schema.Struct<{
    _meta: Schema.decodeTo<Schema.optional<Schema.Struct<{
        /**
         * If specified, the caller is requesting out-of-band progress notifications
         * for this request (as represented by notifications/progress). The value of
     ...
     */
    level: Schema.Literals<["debug", "info", "notice", "warning", "error", "critical", "alert", "emergency"]>;
}>, Schema.Struct<{}>, Schema.Union<readonly [typeof ParseError, typeof InvalidRequest, typeof MethodNotFound, typeof InvalidParams, typeof InternalError, typeof McpErrorBase]>, typeof McpServerClientMiddleware, never> | Rpc.Rpc<"completion/complete", Schema.Struct<{
    readonly ref: Schema.Union<readonly [typeof PromptReference, typeof ResourceReference]>;
    /**
     * The argument's information
     */
...
declare const ClientRpcs_base: RpcGroup.RpcGroup<Rpc.Rpc<"initialize", Schema.Struct<{
    _meta: Schema.decodeTo<Schema.optional<Schema.Struct<{
        /**
         * If specified, the caller is requesting out-of-band progress notifications
         * for this request (as represented by notifications/progress). The value of
