...
export interface AnyProtocolAdapter<out Version extends string = string, HandlerRequirements = unknown> {
    ...
    readonly installHandlers: (core: any, lifecycle: any, target: any) => Effect.Effect<void, never, HandlerRequirements>;
    readonly makeReverseClient: (profile: any) => Effect.Effect<McpSchema.McpReverseClient, never, RpcClient.Protocol | Scope.Scope>;
    readonly projectNotification: (notification: any) => Effect.Effect<ProjectedNotification | undefined, any>;
 ...
 * @since 4.0.0
 */
export interface ProtocolAdapter<out Version extends ProtocolVersion = ProtocolVersion> extends AnyProtocolAdapter<Version> {
}
/**
 ...
 * @since 4.0.0
 */
export declare const v2025_06_18: ProtocolAdapter<"2025-06-18">;
/**
 ...
 * @since 4.0.0
 */
export declare const v2025_03_26: ProtocolAdapter<"2025-03-26">;
/**
 ...
 * @since 4.0.0
 */
export declare const v2024_11_05: ProtocolAdapter<"2024-11-05">;
